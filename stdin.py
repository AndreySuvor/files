#Дан блок кода на языке Python.
#Напишите программу, которая удаляет все строки в данном коде, которые содержат в себе только комментарии.
...
res = [sys.stdout.write(i) for i in sys.stdin if not i.strip().startswith('#')]